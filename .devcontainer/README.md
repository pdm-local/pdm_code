# PDM Code Devcontainer

A complete, containerized development environment for PDM Code - the local-first AI coding assistant.
...
- Docker CLI: `docker exec -it pdm-dev zsh`
...
docker volume rm pdm-pnpm-store
...
|-------|---------|-------------|
| `/workspaces/pdm` | Project source code | Host filesystem |
| `pdm-pnpm-store` | pnpm package cache | Named volume |
...
- **Issues**: [GitHub Issues](https://github.com/pdm-local/pdm_code/issues)
- **Discussions**: [GitHub Discussions](https://github.com/pdm-local/pdm_code/discussions)
