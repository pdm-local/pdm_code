---
title: "Atlas Cloud"
description: "Configure Atlas Cloud as a cloud AI provider for PDM Code"
sidebar_order: 17
---

# Atlas Cloud

[Atlas Cloud](https://www.atlascloud.ai) is a full-modal AI inference platform that exposes video, image, and LLM models through a single API. Rather than wiring up a separate integration per vendor, you connect once and get unified access to 300+ curated models across every modality. For PDM Code, the relevant slice is its OpenAI-compatible LLM endpoint, which works as a drop-in coding provider.
