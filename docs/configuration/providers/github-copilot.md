...
description: "Configure GitHub Copilot as a native AI provider for PDM Code"
sidebar_order: 22
---

# GitHub Copilot

Use your existing GitHub Copilot subscription to access AI models through PDM Code. Authentication is handled via device OAuth flow, no API key needed.
...
2. Run `/copilot-login` inside PDM Code to authenticate via GitHub's device OAuth flow
