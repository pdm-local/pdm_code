 ...
 * forms: a single `.md` file in `.pdm/commands|agents|tools/` (the
 * single-file form) or a directory under `.pdm/skills/` with a
 ...
 * skills, preserves today's `.pdm/tools/*.md` behaviour) or scoped to
