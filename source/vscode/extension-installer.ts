...
export function getVsixPath(): string {
	...
	const possiblePaths = [
		join(__dirname, '../../assets/pdm-vscode.vsix'), // development
		join(__dirname, '../../../assets/pdm-vscode.vsix'), // npm installed
	];
...
/**
 * Check if the pdm VS Code extension is installed in any available VS Code flavor
