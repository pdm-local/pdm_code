...
import {getBraveSearchApiKey} from '@/config/pdm-tools-config';
...
import {getAllToolExports} from '@/tools/index';
...
export class ToolManager {
	...
	constructor() {
		this.registry = ToolRegistry.fromToolExports(getAllToolExports());
	...
	/**
	 * Load file-based custom tools from `.pdm/tools/` (project) and
