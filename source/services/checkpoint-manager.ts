 ...
 * Checkpoints are stored in .pdm/checkpoints/ within the workspace root.
 */
export class CheckpointManager {
	...
	constructor(workspaceRoot: string = process.cwd()) {
		// nosemgrep
		this.checkpointsDir = path.join(workspaceRoot, '.pdm', 'checkpoints'); // nosemgrep
	...
	private getCheckpointDir(name: string): string {
		...
		if (!isPathInside(dir, this.checkpointsDir)) {
